...
!
      ...
      common /gfvsq / sq(0:IGFV)     !   sq(n)  = sqrt(n)
      common /gfvsqi/ sqi(0:IGFV)    !   sqi(n) = 1/sqrt(n)
      common /gfvsqh/ sqh(0:IGFV)    !   sqh(n) = sqrt(n+1/2)
...
!--------------------------------------------------------
  ...
  115 format(a,21x,a,2i5,3x,a,i4)
      ...
      if (icstr.eq.0) then
          ...
          write(l6,'(a,f10.4)' ) ' temperature [MeV]      : ',temp    
      else
...
!                     write(*,*) i, nn, wnn(i,nn)
         ...
         write(*,*) 'Read ', k, ' matrix elements !'
         else
                write(*,*) 'IN SINGD: wrong value of MATEL !'
                stop
         endif
